...
var centerMenu = [
    ...
    ,{
        name: '宣传收藏',
        url: '../xuanchuanCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '宣传',
        url: './pages/xuanchuan/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/yuneifengxianpinggu/admin/dist/index.html#/login";
